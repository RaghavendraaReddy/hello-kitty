...
output "aws_iam_role_hello_kitty_raghav_reddy_arn" {
  value = module.appcd_b71fd16c-797e-5a95-8e1b-ab22f1e34f43.arn
  sensitive = false
}


output "aws_iam_role_hello_kitty_raghav_reddy_name" {
...
output "aws_lambda_hello_kitty_raghav_reddy_function_url" {
